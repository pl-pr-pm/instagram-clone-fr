...
export const fetchAsyncNewPost = createAsyncThunk(
  ...
  async (newPost: PROPS_NEWPOST) => {
    ...
    newPost.img && uploadData.append("img", newPost.img);
    console.log(`fetchAsyncNewPost request uploadData is ${uploadData}`);
...
// djangoの仕様に合わせ、favが残り一つの時、put method ではなく、post methodを利用し、空の配列とする
